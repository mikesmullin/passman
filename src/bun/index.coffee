...
# Electrobun's native macOS webview gets Cmd/Ctrl text-editing shortcuts from
# application-menu roles. Without an Edit menu, the page itself has no JS
# paste handler to fall back to, so Cmd+V is silently ignored in the desktop UI.
